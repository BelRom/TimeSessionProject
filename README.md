...
Для каждого запроса происходит выкачивание данных из yfinance и расчет на 3 моделях (ARIMA, Ridge, SimpleRNN) выбирается по метрикам лучшая
и возврощается ответ, в виде потенциальной прибыли 
...
логи находятся в src/requests_log.csv
